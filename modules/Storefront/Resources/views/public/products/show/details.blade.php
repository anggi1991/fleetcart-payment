<div class="product-details-info position-relative flex-grow-1"> 
    {{-- BAGIAN ATAS (NAMA, RATING, STOK, DESKRIPSI SINGKAT) TETAP TAMPIL UNTUK SEMUA PRODUK --}}
    ...
    {{-- ========================================================= --}}
    {{-- ==== AWAL DARI BLOK LOGIKA BARU "SAKLAR"            ==== --}}
    {{-- ========================================================= --}}

    @if ($product->is_virtual)

        {{-- JIKA PRODUK VIRTUAL: TAMPILKAN OPSI & TOMBOL "HUBUNGI KAMI" --}}
        <div class="details-info-middle">
            {{-- Bagian untuk variasi dan opsi tetap ditampilkan agar pelanggan bisa memilih --}}
            @if ($product->variant)
            ...
            {{-- Tombol Hubungi Kami menggantikan harga, qty, dan tombol beli --}}
            <div class="contact-for-price-wrapper mt-2">
                <a href="https://wa.me/6285888135235?text=Halo%20RazqaShop,%20saya%20tertarik%20untuk%20konsultasi%20mengenai%20produk%20'{{ urlencode($product->name) }}'" target="_blank" class="btn btn-primary btn-lg btn-add-to-cart">
                    <i class="lab la-whatsapp"></i>
                    Hubungi untuk Penawaran
                </a>
                </div>
                <div class="mt-2 text-start d-inline-block">
        <small class="fw-normal" style="font-size: 0.8em; opacity: 0.9;">
            Klik untuk konsultasi & penawaran harga khusus.
        </small>
    </div>
        </div>
    ...
    @else
        ...
        {{-- JIKA PRODUK NORMAL: TAMPILKAN KODE ASLI UNTUK HARGA & PEMBELIAN --}}
        <div class="details-info-middle">
            @if ($product->variant)
    ...
    {{-- BAGIAN BAWAH (SKU, KATEGORI, DLL) TETAP TAMPIL UNTUK SEMUA PRODUK --}}
