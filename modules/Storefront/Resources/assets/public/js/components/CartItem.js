Alpine.data("CartItem", (cartItem) => ({
    ...
    get productUrl() {
    // Ambil prefix lokal dari path, misal: /id atau /en
    const pathParts = window.location.pathname.split('/');
    const locale = (pathParts[1] === 'id' || pathParts[1] === 'en') ? pathParts[1] : 'id'; // default ke 'id'
    let url = `${window.location.origin}/${locale}/products/${this.product.slug}`;
