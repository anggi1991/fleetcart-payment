    ...
    public function rules()
    {
        return array_merge(
            [
             ...
             // ============================================= //
                // ==== BLOK BARU UNTUK VALIDASI FAKTUR PAJAK ==== //
                // ============================================= //
                'tax_invoice_request' => ['nullable', 'boolean'],
                'taxpayer_name' => ['required_if:tax_invoice_request,1', 'nullable', 'string', 'max:255'],
                'taxpayer_id_number' => ['required_if:tax_invoice_request,1', 'nullable', 'string', 'max:255'],
                // =========================================== //
                // ==== AKHIR BLOK BARU                       ==== //
                // =========================================== //
            ],
