...
<!-- START: Modified block for 'is_virtual' switch -->
<div class="form-group row">
    <label
        for="is-virtual"
        class="col-sm-12 control-label text-left"
    >
        <!-- Menggunakan v-html dan fungsi trans() sesuai standar file ini -->
        <b v-html="trans('product::attributes.is_virtual_or_contact')"></b>
    </label>
    ...
    <div class="col-sm-6">
        ...
        <!-- Menambahkan teks bantuan yang jelas di bawah saklar -->
        <span class="help-block">
            Aktifkan saklar ini jika produk tidak memerlukan pengiriman fisik. <br>
            <b>Ini juga akan menyembunyikan harga dan menggantinya dengan tombol "Hubungi Kami" di halaman produk.</b>
        </span>

        <!-- Bagian untuk menampilkan error validasi (tidak diubah) -->
        <span
            class="help-block text-red"
...
<!-- END: Modified block for 'is_virtual' switch -->
                        <div class="form-group row">
                            <label
                                for="is-active"
                                class="col-sm-12 control-label text-left"
